---
title: No Past Performance? How New Firms Win Government Contracts
...
stats:
  - n: "15"
    label: calendar days a prime has to hand a small first-tier subcontractor the past performance rating it asked for, under 13 CFR 125.11
  - n: "30"
    label: days after the prime contract's period of performance ends - the default window for a small sub to request that rating
  - n: "5"
    label: rating levels the prime must use, Exceptional through Unsatisfactory, the same scale as FAR 42.1503
asides:
  - title: Where the neutral rule lives now
    body: For years the rule sat at FAR 15.305(a)(2)(iv). The Revolutionary FAR Overhaul text moves it to 15.202(c)(1), and DoD contracting officers use that text under class deviation 2026-O0048, Revision 1, dated 22 July 2026. Cite whichever numbering your solicitation actually uses.
---
