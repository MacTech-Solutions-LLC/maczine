---
title: "CMMC Class Deviation: The Phase 2 Pause Is Now in the Rulebook"
...
stats:
  - n: "2026-O0025"
    label: DARS tracking number of the class deviation that carries the CMMC pause - Revision 3 was signed 3 September 2026
  - n: "60"
    label: days the CMMC Reform Task Force was given, counted from the 13 July suspension, to deliver its recommendations
  - n: "1,100+"
    label: industry responses to the Department's July request for information on CMMC reform, per DoW CIO Kirsten Davies
asides:
  - title: The 2028 date is not new
    body: Some coverage reads the deviation's November 2028 language as a fresh two-year delay. It is not. The same split - clause insertion at program-office discretion until 9 November 2028, broadly required from 10 November 2028 - already sits in DFARS 204.7504 as the final rule published it. The deviation carried that text over; the pause lives in a separate instruction to contracting officers.
---

When MacZine covered the [CMMC Phase 2 suspension](/maczine/cmmc-phase-2-suspension-review) in July, and then the [subcontract flow-down it left behind](/maczine/cmmc-pause-subcontract-flow-down), the pause was a memo from the Department of War's chief information officer - a policy decision, announced with a 60-day review attached and no contract language of its own. That is no longer an accurate description. The CMMC class deviation signed on 3 September has moved the pause into the acquisition rulebook contracting officers work from, and a pause that lives in the rulebook behaves very differently from one that lives in a press release.
